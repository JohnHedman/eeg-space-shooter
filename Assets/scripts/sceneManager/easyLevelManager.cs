...
public class easyLevelManager : MonoBehaviour
{
    ...
    public float trippleShotStartingTimer = 130.0f;
    public float healthStartingTimer = 30.0f;
    public float shieldStartingTimer = 130.0f;

    public GameObject player;


    private float tripplePowerupTimer = 130.0f;
    private float healthPowerupTimer = 130.0f;
    private float shieldPowerupTimer = 130.0f;
    ...
    void Start()
    {
        tripplePowerupTimer = trippleShotStartingTimer;
        healthPowerupTimer       = healthStartingTimer;
        shieldPowerupTimer       = shieldStartingTimer;
    ...
    void CheckForPowerups()
    {
        if(player != null)
        {
            if(tripplePowerupTimer <= 0 && GetNumberOfEnemies() > 5)
            {
                SpawnTripplePowerup();
